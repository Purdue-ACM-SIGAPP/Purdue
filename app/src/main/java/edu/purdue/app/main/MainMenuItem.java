...
import edu.purdue.app.mail.com.fsck.k9.activity.Accounts;
...
public class MainMenuItem implements CustomMenuItem {
    ...
    public MainMenuItem(Drawable icon, String name, Class<? extends Activity> activity) {
        this.icon = icon;
        this.name = name;
        this.url = null;
    ...
    public static List<MainMenuItem> getDefaultMainMenuItems(Resources r) {
        ...
        toReturn.add(new MainMenuItem(r.getDrawable(R.drawable.ic_mymail), r.getString(R.string.mymail), Accounts.class));
